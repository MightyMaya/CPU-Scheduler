...
constexpr auto qt_meta_stringdata_CLASSFCFS2ENDCLASS = QtMocHelpers::stringData(
    "FCFS2",
    "childClosed",
    "",
...
void FCFS2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FCFS2::*)();
            if (_t _q_method = &FCFS2::childClosed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
