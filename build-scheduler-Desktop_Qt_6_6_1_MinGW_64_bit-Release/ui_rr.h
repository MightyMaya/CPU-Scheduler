...
public:
    ...
    void setupUi(QDialog *RR)
    {
        ...
        BurstTime->setGeometry(QRect(90, 180, 42, 26));
        timeQuantum = new QSpinBox(RR);
        timeQuantum->setObjectName("timeQuantum");
        timeQuantum->setGeometry(QRect(660, 170, 41, 21));
        label_2 = new QLabel(RR);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(10, 180, 91, 21));
        label_3 = new QLabel(RR);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(520, 150, 121, 61));
        QFont font;
