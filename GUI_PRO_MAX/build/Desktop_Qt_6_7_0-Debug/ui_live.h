...
public:
    ...
    void setupUi(QDialog *live)
    {
        ...
        quantum_label = new QLabel(splitter);
        quantum_label->setObjectName("quantum_label");
        QFont font1;
        font1.setPointSize(9);
        quantum_label->setFont(font1);
        splitter->addWidget(quantum_label);
        priorityy = new QSpinBox(splitter);
        priorityy->setObjectName("priorityy");
        splitter->addWidget(priorityy);
        priority_label = new QLabel(splitter);
        priority_label->setObjectName("priority_label");
        splitter->addWidget(priority_label);
        splitter_2 = new QSplitter(live);
        splitter_2->setObjectName("splitter_2");
        splitter_2->setGeometry(QRect(10, 110, 751, 25));
    ...
    void retranslateUi(QDialog *live)
    {
        ...
        quantum_label->setText(QCoreApplication::translate("live", "Quantum Time", nullptr));
        priority_label->setText(QCoreApplication::translate("live", "Priority", nullptr));
