...
constexpr auto qt_meta_stringdata_CLASSsjfnonENDCLASS = QtMocHelpers::stringData(
    "sjfnon",
    "updateChartNeeded",
    "",
    "childClosed",
...
void sjfnon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (sjfnon::*)();
            if (_t _q_method = &sjfnon::childClosed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
